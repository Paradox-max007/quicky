...
async function seed() {
  ...
  // ── Game Hub catalog (Task 8: games must exist in freshly seeded local
  //    dev DBs — the Games hub reads GameDefinition rows, §11). Keep this
  //    list in sync with scripts/seed-game-definitions.mjs (same 8 upserts;
  //    isPlayable stays honest — only Spin the Bottle has a live room).
  const GAMES = [
    { slug: 'spin-the-bottle', name: 'Spin the Bottle', shortDescription: 'Live party table — spins, dares, kisses and gifts in real time.', description: 'Join a live table with up to 12 players. Take turns spinning the bottle, answer truth or dare prompts, send kisses and gifts — every spin is system-controlled and fair.', icon: '🍾', artwork: 'coral', supportedModes: 'GROUP', minPlayers: 2, maxPlayers: 12, isPlayable: true, isFeatured: true, sortOrder: 1 },
    { slug: 'truth-or-dare', name: 'Truth or Dare', shortDescription: 'Classic party truth or dare with playful challenge levels.', description: 'The classic party game with a Quicky twist. Pick truth or dare, match your comfort level, and get to know the other players fast.', icon: '🎯', artwork: 'purple', supportedModes: 'GROUP', minPlayers: 3, maxPlayers: 12, isPlayable: false, isFeatured: false, sortOrder: 2 },
    { slug: 'ludo', name: 'Ludo', shortDescription: 'Board-game night — classic Ludo, 2 to 4 players.', description: 'Classic Ludo with a social layer. Play head-to-head with a partner or open the board to a group.', icon: '🎲', artwork: 'gold', supportedModes: 'BOTH', minPlayers: 2, maxPlayers: 4, isPlayable: false, isFeatured: false, sortOrder: 3 },
    { slug: 'party-quiz', name: 'Party Quiz', shortDescription: 'Fast quiz rounds about love, life and your table friends.', description: 'Quick-fire quiz rounds about relationships, hobbies and the people at your table. Most correct answers wins the round.', icon: '🧠', artwork: 'blue', supportedModes: 'GROUP', minPlayers: 3, maxPlayers: 12, isPlayable: false, isFeatured: false, sortOrder: 4 },
    { slug: 'would-you-rather', name: 'Would You Rather', shortDescription: 'Two impossible choices — vote and see where the table lands.', description: 'Vote between two impossible choices and see how the rest of the table voted. Great conversations start here.', icon: '🤔', artwork: 'purple', supportedModes: 'GROUP', minPlayers: 2, maxPlayers: 12, isPlayable: false, isFeatured: false, sortOrder: 5 },
    { slug: 'never-have-i-ever', name: 'Never Have I Ever', shortDescription: 'Confessions, laughter and getting to know each other.', description: 'The ice-breaker classic. Read a confession, everyone who has done it owns up — expect stories.', icon: '🙈', artwork: 'coral', supportedModes: 'GROUP', minPlayers: 3, maxPlayers: 12, isPlayable: false, isFeatured: false, sortOrder: 6 },
    { slug: 'guess-who', name: 'Guess Who', shortDescription: 'Guess who said what — with anonymous table answers.', description: 'Players answer anonymously, then everyone guesses who said what. The closest reader of the table wins.', icon: '🕵️', artwork: 'blue', supportedModes: 'BOTH', minPlayers: 2, maxPlayers: 6, isPlayable: false, isFeatured: false, sortOrder: 7 },
    { slug: 'charades', name: 'Charades', shortDescription: 'Act it out — fast, funny party guessing rounds.', description: 'Act out the prompt while your table races to guess. Camera-on chaos, maximum laughter.', icon: '🎭', artwork: 'gold', supportedModes: 'GROUP', minPlayers: 4, maxPlayers: 12, isPlayable: false, isFeatured: false, sortOrder: 8 },
  ] as const
