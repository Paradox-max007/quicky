...
ok('ludo dice LIFECYCLE FIX: dedicated diceTimersRef — the board re-render can never wipe the stop/hide timers (tumble-forever bug)', has('src/components/quicky/ludo/LudoGameArea.tsx', 'diceTimersRef', 'DEDICATED dice timers', 'setDiceVisible(false)'))
