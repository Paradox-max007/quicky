...
ok('primary screen: Chat/Friends icons INSIDE the profile card flanking the profile image circle (v2 §4a)', has('src/components/quicky/game-primary/GamePrimaryScreen.tsx', 'aria-label="Open game chats"', 'aria-label="Open friends"', 'game-primary-chat-icon', 'game-primary-friends-icon', '<MessageCircle', '<Users', 'game-primary-profile-card'))
