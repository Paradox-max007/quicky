...
// Quicky — Gift Sheet (Games PRD §18-§28)
// Bottom-sheet bulk gifting for the Spin the Bottle room. The catalog is
// DB-DRIVEN (admin-managed, nothing hardcoded). PRD structure:
//
//   Send a Gift
...
//   Quantity [ 1 ] [ 10 ] [ 50 ] [ 100 ] [ 1000 ]   (§21, default 1)
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-4 pb-3">
              ...
              {/* §21 — quantity chips: 1 / 10 / 50 / 100 / 1000, default 1 */}
              {giftDef && (
                <div className="mt-4">
