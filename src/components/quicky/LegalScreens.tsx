      ...
      <div className="px-5 py-5">
        ...
        >
          <motion.div
            ...
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--qk-accent)] to-[var(--qk-accent-light)] flex items-center justify-center glow-coral mb-3"
          >
        ...
        <motion.div
          ...
          className="bg-[var(--qk-accent)]/10 border border-[var(--qk-accent)]/30 rounded-2xl p-3 mb-4 flex items-start gap-2"
        >
          <AlertTriangle className="w-4 h-4 text-[var(--qk-accent)] shrink-0 mt-0.5" />
        ...
        <div className="flex flex-col gap-4">
          <Section icon={<Heart className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="1. Acceptance of Terms" delay={0.4}>
          ...
          <Section icon={<FileText className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="2. Eligibility" delay={0.5}>
          ...
          <Section icon={<Shield className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="3. User Conduct" delay={0.6}>
          ...
          <Section icon={<Heart className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="4. Content & Media" delay={0.7}>
          ...
          <Section icon={<Scale className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="5. Subscriptions & Payments" delay={0.8}>
          ...
          <Section icon={<Shield className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="6. Privacy" delay={0.9}>
          ...
          <Section icon={<AlertTriangle className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="7. Disclaimers & Limitation of Liability" delay={1.0}>
          ...
          <Section icon={<RefreshCw className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="8. Changes to Terms" delay={1.1}>
          ...
          <Section icon={<FileText className="w-4 h-4 text-[var(--qk-accent-light)]" />} title="9. Contact" delay={1.2}>
            If you have questions about these Terms, please contact us at <span className="text-[var(--qk-accent-light)] font-medium">legal@quicky.app</span>. For support-related questions, use the Help &amp; Support option in Settings.
          </Section>
        </div>
      </div>
    </SettingsSubScreen>
      ...
      <div className="px-5 py-5">
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, rotate: 0 }}
            transition={{ type: 'spring', stiffness: 200, damping: 15, delay: 0.1 }}
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--qk-purple)] to-[var(--qk-accent-light)] flex items-center justify-center glow-coral mb-3"
          >
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3 }}
          className="bg-[var(--qk-purple)]/10 border border-[var(--qk-purple)]/30 rounded-2xl p-3 mb-4 flex items-start gap-2"
        >
          <Shield className="w-4 h-4 text-[var(--qk-purple)] shrink-0 mt-0.5" />
          <p className="text-xs text-white/80">
        ...
        <div className="flex flex-col gap-4">
          <Section icon={<FileText className="w-4 h-4 text-[var(--qk-purple)]" />} title="1. Information We Collect" delay={0.4}>
          ...
          <Section icon={<Heart className="w-4 h-4 text-[var(--qk-purple)]" />} title="2. How We Use Your Data" delay={0.5}>
          ...
          <Section icon={<Scale className="w-4 h-4 text-[var(--qk-purple)]" />} title="3. Data Sharing" delay={0.6}>
          ...
          <Section icon={<Shield className="w-4 h-4 text-[var(--qk-purple)]" />} title="4. Your Privacy Controls" delay={0.7}>
          ...
          <Section icon={<AlertTriangle className="w-4 h-4 text-[var(--qk-purple)]" />} title="5. Data Retention" delay={0.8}>
          ...
          <Section icon={<FileText className="w-4 h-4 text-[var(--qk-purple)]" />} title="6. Security" delay={0.9}>
          ...
          <Section icon={<RefreshCw className="w-4 h-4 text-[var(--qk-purple)]" />} title="7. Your Rights" delay={1.0}>
            Depending on your jurisdiction (GDPR, CCPA, etc.), you may have rights to: (a) access the personal data we hold about you; (b) request correction or deletion of your data; (c) export your data in a portable format; (d) object to certain processing. To exercise these rights, contact us at <span className="text-[var(--qk-purple)] font-medium">privacy@quicky.app</span>.
          </Section>

          <Section icon={<Heart className="w-4 h-4 text-[var(--qk-purple)]" />} title="8. Children&apos;s Privacy" delay={1.1}>
            Quicky is not directed to anyone under 18. We do not knowingly collect personal data from children. If we learn that a user under 18 has registered, we will delete their account immediately. If you believe a minor is using the Service, please report it to <span className="text-[var(--qk-purple)] font-medium">safety@quicky.app</span>.
          </Section>

          <Section icon={<FileText className="w-4 h-4 text-[var(--qk-purple)]" />} title="9. Contact" delay={1.2}>
            For privacy questions or requests, contact us at <span className="text-[var(--qk-purple)] font-medium">privacy@quicky.app</span>. For legal questions, contact <span className="text-[var(--qk-purple)] font-medium">legal@quicky.app</span>.
          </Section>
        </div>
      </div>
    </SettingsSubScreen>
